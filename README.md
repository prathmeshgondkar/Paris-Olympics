...
A full-scale, cloud-native data project built to simulate and analyze the Paris 2024 Olympics using Microsoft Azure. This end-to-end pipeline covers everything from data ingestion to dashboarding, integrating tools like **Azure Data Factory**, **Databricks**, **Synapse Analytics**, **Power BI**, **Python**, and **Apache Spark**.
...
- Design cross-region architecture for latency and cost optimization
- Transform and analyze data using Spark and SQL
...
| Project Skills    | Orchestration, Cross-Region Design, Cost Optimization   |

---

## 🗂️ Data Sources

- 🧠 **90% Synthetic Data** generated using ChatGPT (e.g., athletes, coaches)
- 📊 **10% Real Data** from Kaggle (e.g., medals, entries by gender)
...
- 🗃️ Organized data zones (Raw vs Transformed)
...
- 🧮 Data modeling and analysis in Synapse SQL
